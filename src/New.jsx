...
const New = () => {
  ...
  const correctCount = answers.filter(
    (answer, index) => answer === initialQuestions[index].correctAnswer
  ).length;

  // Prevent unnecessary re-rendering
  useEffect(() => {
    // Bu useEffect state yangilanishlari haqida faqatgina zarur bo'lganda ishlaydi
  }, [answers]); // faqat answers o'zgarganda yangilanishi
    ...
    <div className="app">
      ...
      {!showResults ? (
        ...
        <div className="results">
          ...
          <p className="score">
            Correct Answers: {correctCount} / {initialQuestions.length}
          </p>
          <p className="score">
            Incorrect Answers: {initialQuestions.length - correctCount}
          </p>
